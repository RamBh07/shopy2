...
//                 <p className="text-lg font-semibold">Thank you, {user}!</p>
            ...
            >
                ...
                <div className="space-y-4 mb-4 text-left">
                    <p className="text-gray-700">
                        Thank you &nbsp; {user} for your purchase. We&apos;re processing your order and
                    ...
                    <p className="text-gray-700">
                        Payment Id:{" "}
                        <span className="text-black font-semibold">{paymentId}</span>
                    </p>
                </div>
